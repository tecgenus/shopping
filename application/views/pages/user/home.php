...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo USERURL; ?>assets/css/bootstrap.min.css" media="all" />
        <link rel="stylesheet" type="text/css" href="<?php echo USERURL; ?>assets/css/font-awesome.min.css" media="all" />
        <link rel="stylesheet" type="text/css" href="<?php echo USERURL; ?>assets/css/animate.min.css" media="all" />
        <link rel="stylesheet" type="text/css" href="<?php echo USERURL; ?>assets/css/font-electro.css" media="all" />
        <link rel="stylesheet" type="text/css" href="<?php echo USERURL; ?>assets/css/owl-carousel.css" media="all" />
        <link rel="stylesheet" type="text/css" href="<?php echo USERURL; ?>assets/css/style.css" media="all" />
        <link rel="stylesheet" type="text/css" href="<?php echo USERURL; ?>assets/css/colors/yellow.css" media="all" />

      
        <link rel="shortcut icon" href="<?php echo USERURL; ?>assets/images/fav-icon.png">
    </head>
    ...
    <body class="home-v2">
        ...
        <script type="text/javascript" src="<?php echo USERURL; ?>assets/js/jquery.min.js"></script>
        <script type="text/javascript" src="<?php echo USERURL; ?>assets/js/tether.min.js"></script>
        <script type="text/javascript" src="<?php echo USERURL; ?>assets/js/bootstrap.min.js"></script>
        <script type="text/javascript" src="<?php echo USERURL; ?>assets/js/bootstrap-hover-dropdown.min.js"></script>
        <script type="text/javascript" src="<?php echo USERURL; ?>assets/js/owl.carousel.min.js"></script>
        <script type="text/javascript" src="<?php echo USERURL; ?>assets/js/echo.min.js"></script>
        <script type="text/javascript" src="<?php echo USERURL; ?>assets/js/wow.min.js"></script>
        <script type="text/javascript" src="<?php echo USERURL; ?>assets/js/jquery.easing.min.js"></script>
        <script type="text/javascript" src="<?php echo USERURL; ?>assets/js/jquery.waypoints.min.js"></script>
        <script type="text/javascript" src="<?php echo USERURL; ?>assets/js/electro.js"></script>
